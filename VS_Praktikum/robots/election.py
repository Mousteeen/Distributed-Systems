...
class RobotClient:
    ...
    def start_election(self):
        ...
        # print(f"Robot {ROBOT_ID} starts election")
        ...
        for higher_robot in higher_robots:
            # print(f"Robot {self.robot_id} sent election request to Robot {higher_robot}")
    ...
    def on_mqtt_message(self, client, userdata, msg):
        ...
        # self.logger.info(f"Robot {payload[-1]} {self.ACK}{self.in_election}")
        if msg.topic == self.LEADER_TOPIC:
            ...
            init_robot = payload[-2]
            # print(f"Robot {self.robot_id} received ACK from {init_robot}")
